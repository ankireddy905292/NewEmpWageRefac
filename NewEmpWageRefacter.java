...
public class NewEmpWageRefacter {
    ...
    public  NewEmpWageRefacter(String company, int wagePerHr, int maxMonthHr, int workingDays, int fullTimeHr, int partTimeHr) {
...
class EmpWageArry {
    ...
    private NewEmpWageRefacter[] compnyWageArray;

    public EmpWageArry(){
        compnyWageArray = new NewEmpWageRefacter[5];
    }

    public void addCompanyEmpWage(String company, int wagePerHr, int maxMonthHr, int workingDays, int fullTimeHr, int partTimeHr) {
        compnyWageArray[numOfCmpny] = new NewEmpWageRefacter(company,wagePerHr,maxMonthHr,workingDays,fullTimeHr,partTimeHr);
